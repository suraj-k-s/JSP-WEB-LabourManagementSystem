                ...
                <table width="200" border="1">
                    <tr>
                        ...
                        <td><label for="txt_name"></label>
                            <input type="text" name="txt_name" value="<%=rs.getString("user_name")%>" id="txt_name" /></td>
                    </tr>
                    <tr>
                        <td>Contact</td>
                        <td><label for="txt_contact"></label>
                            <input type="text" name="txt_contact" value="<%=rs.getString("user_contact")%>" id="txt_contact" /></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><label for="txt_email"></label>
                            <input type="text" name="txt_email"  value="<%=rs.getString("user_email")%>" /></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                        <td><label for="txt_address"></label>
                            <textarea name="txt_address"  id="txt_address" cols="45" rows="5"><%=rs.getString("user_address")%></textarea></td>
