...
<%
    if (request.getParameter("btn_pay") != null) {
        if (!request.getParameter("txt_bid").equals(null)) {
            String a = "update tbl_workpost set workpost_status='5' where workpost_id='"+request.getParameter("txt_bid")+"'";
            ...
            <form method="POST">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <input type="hidden" value="<%=request.getParameter("bid")%>" name="txt_bid">
                        <input type="hidden" value="<%=request.getParameter("pid")%>" name="txt_pid">
