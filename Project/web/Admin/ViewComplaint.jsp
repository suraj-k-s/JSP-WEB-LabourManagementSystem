...
<title>Untitled Document</title>
  <%@include file="SessionValidator.jsp" %>
    ...
    if(request.getParameter("btn_save")!=null) {
            ...
            String upQry = "update tbl_complaint set complaint_reply='"+request.getParameter("txt_reply")+"',complaint_status='1' where complaint_id='"+request.getParameter("hid")+"'";
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%
												int i = 0;
                                                String selQry = "select * from tbl_complaint c inner join tbl_complainttype t on t.complainttype_id=c.complainttype_id inner join tbl_user u on c.user_id = u.user_id where complaint_status='0'";
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%
												int j = 0;
                                                String selQry1 = "select * from tbl_complaint c inner join tbl_complainttype t on t.complainttype_id=c.complainttype_id inner join tbl_user u on c.user_id = u.user_id where complaint_status='1'";
