                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                           <div class="navbar-nav mr-auto">
                                ...
                                <a href="WorkPost.jsp" class="nav-item nav-link">Post</a>
                                <a href="WorkRequest.jsp" class="nav-item nav-link">Request</a>
                                <a href="WorkGallery.jsp" class="nav-item nav-link">Gallery</a>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            ...
                            <h1 class="animated fadeInLeft"><%=session.getAttribute("labourname")%></h1>
                        </div>
                    </div>
