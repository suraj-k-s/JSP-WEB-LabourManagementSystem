...
if(request.getParameter("btn_save")!=null)
{
	...
	String sel="select * from tbl_labour where labour_id='"+session.getAttribute("labourid")+"'";
        ...
        data.next();
	String dbPassword = data.getString("labour_password");
		
		if(dbPassword.equals(currentPassword))
		{
				if(newPassword.equals(rePassword))
				{
					String up="update tbl_labour set labour_password='"+newPassword+"' where labour_id='"+session.getAttribute("labourid")+"'";
