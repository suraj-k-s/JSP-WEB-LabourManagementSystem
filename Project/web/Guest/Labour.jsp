<%-- 
    Document   : Labour
    Created on : Dec 26, 2021, 10:05:51 PM
    Author     : PSST
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="contact-form">
                                <div id="success"></div>
                                <form method="post" enctype="multipart/form-data" action="../ActionPages/LabourUploadAction.jsp" autocomplete="off">
                                    ...
                                    <div class="control-group">
                                        <select name="sel_type" class="form-control" id="sel_type" style="background-color:transparent" required data-validation-required-message="Please enter your Type" >
                                            ...
                                            <%
                                                ...
                                                while (rs1.next()) {
                                            %>
                                            <option style="text-align:center" value="<%=rs1.getString("worktype_id")%>" 
                                                    ><%=rs1.getString("worktype_name")%></option >
