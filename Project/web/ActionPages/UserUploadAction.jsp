...
if(isMultipart)
{
   ...
   Iterator itr=items_list.iterator();
    ...
    String str1="insert into tbl_user(user_name,user_contact,user_email,user_photo,user_address,town_id,user_password)"
            + "values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+ph+"','"+value[3]+"','"+value[6]+"','"+value[7]+"')";
